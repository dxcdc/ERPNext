...
class StaticSafetyTest(unittest.TestCase):
    ...
    def test_cdc_reports_workspace_has_one_rbac_scoped_data_contract(self):
        api_source = API_PY.read_text()
        reports_source = (ROOT / "apps/cdc_theme/cdc_theme/reports.py").read_text()
        ...
        self.assertIn('sed.s_warehouse IN', reports_source)
        self.assertIn('sed.t_warehouse IN', reports_source)
        self.assertIn('REPORT_MAX_ROWS = 50000', reports_source)
    ...
    def test_ongsys_admin_mapping_and_resilient_importer_are_guarded(self):
        ...
        self.assertIn("data-cdc-map-validate-selected", admin_source)
        self.assertIn("Ativar validados", admin_source)
        ...
        self.assertIn("timeout=15", discovery_source)
    ...
    def test_ongsys_stock_import_service_remains_locked_for_manual_fallback(self):
        ...
        self.assertIn("Core M2M", service)
    ...
    def test_common_scope_protects_native_routes_and_empty_links(self):
        ...
        self.assertIn('cdc_theme.js?v=20260908_integration_system_manager_v77', hooks_source)
    ...
    def test_cdc_tests_page_exposes_ten_honest_quality_gates_and_theme_repair(self):
        ...
        self.assertIn('"attention_impact"', api_source)
        self.assertIn('"attention_next_step"', api_source)
    ...
    def test_management_endpoint_uses_native_permissions_and_real_data(self):
        ...
        self.assertNotIn('{"label": "Valor em estoque"', endpoint_source)
    ...
    def test_training_preview_is_last_has_icon_and_does_not_simulate_courses(self):
        ...
        self.assertIn('_ensure_cdc_workspace(CDC_TRAINING_WORKSPACE, "education", 12.0)', api_source)
        self.assertIn('(CDC_TRAINING_WORKSPACE, 12.0, "education")', api_source)
        self.assertIn("'CDC Treinamento', 'CDC Treinamento', 12.0, 'Core', 'education'", terraform_source)
